...
CREATE TABLE `project_progress` (
  ...
  `kpi_result` varchar(225) DEFAULT NULL,
  `target_compare` varchar(225) DEFAULT NULL,
  `problem_note` varchar(225) DEFAULT NULL,
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `project_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `project_name_idx` (`project_id`),
  CONSTRAINT `project_name` FOREIGN KEY (`project_id`) REFERENCES `project` (`id`)
