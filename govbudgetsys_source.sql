...
CREATE TABLE `source` (
  ...
  `statementsource` varchar(225) DEFAULT NULL,
  ...
  CONSTRAINT `year` FOREIGN KEY (`year_id`) REFERENCES `year` (`id`)
...
INSERT INTO `source` VALUES (3,'รัฐบาลไทย',11,7),(4,'wt4wtqrwt',11,7),(5,'สทวท้วส',11,7),(6,'รัฐบาลไทย',11,7);
